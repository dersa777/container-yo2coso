...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yo2coso.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yo2coso.containers.anotherwebservice.com/
...
```
git clone git@github.com:dersa777/container-yo2coso.git
cd container-yo2coso
```
...
```
docker attach container-yo2coso
```
